...
const page = () => {
  return (
    ...
    <div className="flex justify-center ml-8">
      ...
      <div className="ml-2"> {/* Add margin to move the section to the right */}
      <ThisWeek />
    </div>
      <h2 className="text-lg ml-2 font-medium mt-2">My Performance</h2>
  ...
  <div>
    ...
    <div className="p-6 gap-y-6 bg-white my-4 rounded-md dark:bg-slate-800">
      ...
      <div className="border-b border-gray-300 h-1"></div> {/* Line */}
      <div className="mt-2">
        <a href="#" className="text-blue-500 hover:text-blue-700 text-sm font-bold">VIEW ALL ACTIVITY</a> {/* Clickable link */}
      </div>
    </div>
  </div>
