      ...
      <div className=" flex ">
        <div className=" ml-4 mt-4  ">
          <div className=" flex flex-col gap-2 justify-center items-center text-center bg-white rounded-xl w-32  h-28">
            ...
            <p className="text-xs font-semibold text-inherit">FINISHED COURSES</p>
            <p>3</p>
          </div>
        </div>
        <div className=" ml-4 mt-4  ">
        ...
        <div className=" ml-4 mt-4  ">
          <div className=" flex flex-col gap-2 justify-center items-center text-center bg-white rounded-xl w-32  h-28">
            ...
            <p className="text-xs font-semibold text-inherit">SKILLS ACHIEVED</p>
            <p>3</p>
          </div>
        </div>
    </div>
    ...
    <div className=" flex gap-4 bg-white w-[26rem] rounded-xl ml-4 mt-4 p-2">
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="  w-4/4 h-2 bg-slate-400 rounded-xl">
          <div className=" h-full bg-red-200  w-12 rounded-xl">
          </div>
        </div>
    ...
    <div className=" mt-8">
      ...
      <div className=" mt-8  bg-white w-[26rem] p-4 h-40 rounded-xl">
        <div className="flex   justify-around">
          ...
          <div className=" flex gap-4">
            <button className=" bg-indigo-400 rounded-xl p-1 text-white">Follow</button>
            <button className=" bg-indigo-400 rounded-xl p-1 text-white">Message</button>
          </div>
      ...
      <div className=" mt-8 bg-white w-[26rem] p-4 h-40 rounded-xl">
        <div className="flex   justify-around">
          ...
          <div className=" flex gap-4">
            <button className=" bg-indigo-400 rounded-xl p-1 text-white">Profile</button>
            <button className=" bg-indigo-400 rounded-xl p-1 text-white">Delete</button>
          </div>
      ...
      <button className=" bg-red-300 rounded-xl w-[12rem] p-1 text-white ">FIND FRIENDS</button>
      <button className="bg-red-300 w-[12rem] rounded-xl p-1 text-white ">INVITE FRIENDS</button>
      </div>
