...
const NavigationBar = () => {
  ...
  return (
    <div className="z-[2] md:bg-slate-100 backdrop-blur-md flex flex-col-reverse justify-center items-center sticky left-0 bottom-0 gap-4 w-full h-16 md:flex-col md:w-[4rem] md:h-screen dark:bg-slate-700 ">
